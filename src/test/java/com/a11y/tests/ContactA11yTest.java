...
public class ContactA11yTest {
    ...
    public void setup() {
        ...
        report = new A11yReportManager("target/contact-report.html");
    }

    @Test
    public void checkContactPageWCAG22AA() throws InterruptedException {

        report.startTest(
            "Contact Page WCAG 2.2 AA Scan",
            "Automated accessibility scan of the Contact page"
        );
